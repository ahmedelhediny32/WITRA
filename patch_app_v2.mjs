...
const endIdx = content.indexOf("function renderAdminReports(container) {");
...
content = content.substring(0, startIdx) + replacementCode + content.substring(endIdx);
fs.writeFileSync("public/static/app.js", content, "utf8");
console.log("Successfully patched app.js without deleting renderAdminReports");
